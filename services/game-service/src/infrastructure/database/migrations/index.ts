...
import { migration as createGamesTable } from './001_create_games_table';
import { migration as addTournamentFields } from './002_add_tournament_id';
import { Migration } from './types';

const migrations: Migration[] = [createGamesTable, addTournamentFields];
...
async function ensureMigrationsTable(db: GameDatabase): Promise<void> {
    await db.exec(`
...
async function getAppliedMigrationNames(db: GameDatabase): Promise<Set<string>> {
